...
public class OrderApplication implements CommandLineRunner{
	...
	public OrderApplication(OrderRepository orderRepository, ProductRepository productRepository, AppUserRepository appUserRepository, ObjectProvider<SecurityUtils> securityUtilsProvider) {
